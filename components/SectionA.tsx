      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-6 space-y-4">
            <motion.p
              variants={fadeUpVariant}
              className="text-base font-light text-zinc-400 leading-relaxed tracking-wide"
            >
          ...
          <motion.div
            variants={fadeUpVariant}
            className="flex justify-center items-center mt-8 divide-x divide-zinc-800"
          >
            {/* Stat 1 */}
            <div className="flex flex-col items-center px-4 md:px-8">
              <span className="text-2xl font-bold text-white">1+</span>
              <span className="text-[10px] md:text-xs text-zinc-500 mt-1 uppercase tracking-wider">Years of Experience</span>
            </div>

            {/* Stat 2 */}
            <div className="flex flex-col items-center px-4 md:px-8">
              <span className="text-2xl font-bold text-white">5+</span>
              <span className="text-[10px] md:text-xs text-zinc-500 mt-1 uppercase tracking-wider">Projects Done</span>
            </div>

            {/* Stat 3 */}
            <div className="flex flex-col items-center px-4 md:px-8">
              <span className="text-2xl font-bold text-white">💼</span>
              <span className="text-[10px] md:text-xs text-zinc-500 mt-1 uppercase tracking-wider">Available for Freelance</span>
            </div>
          </motion.div>
        </div>
      </motion.div>
